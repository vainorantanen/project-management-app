...
export async function POST(req: any) {
  try {
    ...
    const confirmLink = process.env.NODE_ENV === 'production' ? `https://www.doori.fi/vahvista-sahkoposti/${user.id}/${token}` :
      `http://localhost:3000/confirm-email/${user.id}/${token}`
    ...
    var mailOptions = {
      ...
      to: email,
      subject: 'Sähköpostin vahvistus Doori.fi',
      html: `
      <p>Kiitos rekisteröitymisestä Doori.fi-palveluun! Siirry Dooriin vahvistamaan sähköpostisi alla olevasta napista:</p>
